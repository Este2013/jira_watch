...
class JiraWorkflow {
  /// Returns a new [JiraWorkflow] instance.
  JiraWorkflow({
    this.created,
    this.description,
    this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is JiraWorkflow &&
  ...
  @override
  String toString() => 'JiraWorkflow[created=$created, description=$description, id=$id, isEditable=$isEditable, loopedTransitionContainerLayout=$loopedTransitionContainerLayout, name=$name, scope=$scope, startPointLayout=$startPointLayout, statuses=$statuses, taskId=$taskId, transitions=$transitions, updated=$updated, version=$version]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.isEditable != null) {
      json[r'isEditable'] = this.isEditable;
    } else {
      json[r'isEditable'] = null;
    }
  ...
  /// Returns a new [JiraWorkflow] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static JiraWorkflow? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return JiraWorkflow(
        ...
        isEditable: mapValueOfType<bool>(json, r'isEditable'),
  ...
  static List<JiraWorkflow> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <JiraWorkflow>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = JiraWorkflow.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, JiraWorkflow> mapFromJson(dynamic json) {
    final map = <String, JiraWorkflow>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = JiraWorkflow.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of JiraWorkflow-objects as value to a dart map
  static Map<String, List<JiraWorkflow>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<JiraWorkflow>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = JiraWorkflow.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
