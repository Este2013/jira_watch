...
class Attachment {
  ...
  @override
  String toString() => 'Attachment[author=$author, content=$content, created=$created, filename=$filename, id=$id, mimeType=$mimeType, self=$self, size=$size, thumbnail=$thumbnail]';
