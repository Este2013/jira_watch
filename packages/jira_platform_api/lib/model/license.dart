...
class License {
  ...
  @override
  String toString() => 'License[applications=$applications]';
  ...
  static License? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'applications'), 'Required key "License[applications]" is missing from JSON.');
        assert(json[r'applications'] != null, 'Required key "License[applications]" has a null value in JSON.');
        return true;
      }());

      return License(
        applications: LicensedApplication.listFromJson(json[r'applications']),
      );
    }
    return null;
  }
