...
class IssueBean {
  ...
  static IssueBean? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IssueBean(
        changelog: PageOfChangelogs.fromJson(json[r'changelog']),
        editmeta: IssueUpdateMetadata.fromJson(json[r'editmeta']),
        expand: mapValueOfType<String>(json, r'expand'),
        fields: mapCastOfType<String, Object>(json, r'fields') ?? const {},
        fieldsToInclude: IncludedFields.fromJson(json[r'fieldsToInclude']),
