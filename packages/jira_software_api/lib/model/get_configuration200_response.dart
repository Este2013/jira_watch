...
class GetConfiguration200Response {
  /// Returns a new [GetConfiguration200Response] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetConfiguration200Response &&
  ...
  @override
  String toString() => 'GetConfiguration200Response[columnConfig=$columnConfig, estimation=$estimation, filter=$filter, id=$id, location=$location, name=$name, ranking=$ranking, self=$self, subQuery=$subQuery, type=$type]';
  ...
  /// Returns a new [GetConfiguration200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetConfiguration200Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<GetConfiguration200Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GetConfiguration200Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetConfiguration200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetConfiguration200Response> mapFromJson(dynamic json) {
    final map = <String, GetConfiguration200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetConfiguration200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GetConfiguration200Response-objects as value to a dart map
  static Map<String, List<GetConfiguration200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetConfiguration200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetConfiguration200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
