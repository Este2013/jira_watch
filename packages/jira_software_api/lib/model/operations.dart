...
class Operations {
  ...
  bool operator ==(Object other) => identical(this, other) || other is Operations &&
    _deepEquality.equals(other.linkGroups, linkGroups);
  ...
  @override
  String toString() => 'Operations[linkGroups=$linkGroups]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'linkGroups'] = this.linkGroups;
    return json;
  }
  ...
  static Operations? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Operations(
        linkGroups: LinkGroup.listFromJson(json[r'linkGroups']),
      );
    }
    return null;
  }
