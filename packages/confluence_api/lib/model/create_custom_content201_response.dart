...
class CreateCustomContent201Response {
  /// Returns a new [CreateCustomContent201Response] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateCustomContent201Response &&
    other.id == id &&
    other.type == type &&
    other.status == status &&
    other.title == title &&
  ...
  /// Returns a new [CreateCustomContent201Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateCustomContent201Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CreateCustomContent201Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreateCustomContent201Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateCustomContent201Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreateCustomContent201Response> mapFromJson(dynamic json) {
    final map = <String, CreateCustomContent201Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateCustomContent201Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CreateCustomContent201Response-objects as value to a dart map
  static Map<String, List<CreateCustomContent201Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateCustomContent201Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateCustomContent201Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
