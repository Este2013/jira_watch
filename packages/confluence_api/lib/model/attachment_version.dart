...
class AttachmentVersion {
  ...
  @override
  String toString() => 'AttachmentVersion[createdAt=$createdAt, message=$message, number=$number, minorEdit=$minorEdit, authorId=$authorId, attachment=$attachment]';
  ...
  static AttachmentVersion? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AttachmentVersion(
        ...
        attachment: VersionedEntity.fromJson(json[r'attachment']),
      );
    }
    return null;
  }
