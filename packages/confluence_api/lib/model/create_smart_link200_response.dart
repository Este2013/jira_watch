...
class CreateSmartLink200Response {
  /// Returns a new [CreateSmartLink200Response] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateSmartLink200Response &&
    other.id == id &&
    other.type == type &&
    other.status == status &&
    other.title == title &&
  ...
  @override
  String toString() => 'CreateSmartLink200Response[id=$id, type=$type, status=$status, title=$title, parentId=$parentId, parentType=$parentType, position=$position, authorId=$authorId, ownerId=$ownerId, createdAt=$createdAt, embedUrl=$embedUrl, spaceId=$spaceId, version=$version, links=$links]';
  ...
  /// Returns a new [CreateSmartLink200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateSmartLink200Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CreateSmartLink200Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreateSmartLink200Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateSmartLink200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreateSmartLink200Response> mapFromJson(dynamic json) {
    final map = <String, CreateSmartLink200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateSmartLink200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CreateSmartLink200Response-objects as value to a dart map
  static Map<String, List<CreateSmartLink200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateSmartLink200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateSmartLink200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
