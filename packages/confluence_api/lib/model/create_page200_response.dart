...
class CreatePage200Response {
  /// Returns a new [CreatePage200Response] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreatePage200Response &&
    other.id == id &&
    other.status == status &&
    other.title == title &&
  ...
  /// Returns a new [CreatePage200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreatePage200Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CreatePage200Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreatePage200Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreatePage200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreatePage200Response> mapFromJson(dynamic json) {
    final map = <String, CreatePage200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreatePage200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CreatePage200Response-objects as value to a dart map
  static Map<String, List<CreatePage200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreatePage200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreatePage200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
