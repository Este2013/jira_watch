...
class CreateFolder200Response {
  ...
  @override
  String toString() => 'CreateFolder200Response[id=$id, type=$type, status=$status, title=$title, parentId=$parentId, parentType=$parentType, position=$position, authorId=$authorId, ownerId=$ownerId, createdAt=$createdAt, spaceId=$spaceId, version=$version, links=$links]';
