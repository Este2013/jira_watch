...
class CreateFooterComment201Response {
  /// Returns a new [CreateFooterComment201Response] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateFooterComment201Response &&
    other.id == id &&
    other.status == status &&
    other.title == title &&
  ...
  /// Returns a new [CreateFooterComment201Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateFooterComment201Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CreateFooterComment201Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreateFooterComment201Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateFooterComment201Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreateFooterComment201Response> mapFromJson(dynamic json) {
    final map = <String, CreateFooterComment201Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateFooterComment201Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CreateFooterComment201Response-objects as value to a dart map
  static Map<String, List<CreateFooterComment201Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateFooterComment201Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateFooterComment201Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
