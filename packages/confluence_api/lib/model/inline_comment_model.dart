...
class InlineCommentModel {
  /// Returns a new [InlineCommentModel] instance.
  InlineCommentModel({
    this.id,
    this.status,
    this.title,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InlineCommentModel &&
    other.id == id &&
    other.status == status &&
    other.title == title &&
  ...
  /// Returns a new [InlineCommentModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InlineCommentModel? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<InlineCommentModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InlineCommentModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InlineCommentModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InlineCommentModel> mapFromJson(dynamic json) {
    final map = <String, InlineCommentModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InlineCommentModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InlineCommentModel-objects as value to a dart map
  static Map<String, List<InlineCommentModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InlineCommentModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InlineCommentModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
