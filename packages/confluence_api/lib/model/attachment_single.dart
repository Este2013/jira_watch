...
class AttachmentSingle {
  /// Returns a new [AttachmentSingle] instance.
  AttachmentSingle({
    this.id,
    this.status,
    this.title,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AttachmentSingle &&
    other.id == id &&
    other.status == status &&
    other.title == title &&
  ...
  /// Returns a new [AttachmentSingle] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AttachmentSingle? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<AttachmentSingle> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AttachmentSingle>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AttachmentSingle.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AttachmentSingle> mapFromJson(dynamic json) {
    final map = <String, AttachmentSingle>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AttachmentSingle.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AttachmentSingle-objects as value to a dart map
  static Map<String, List<AttachmentSingle>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AttachmentSingle>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AttachmentSingle.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
