...
class CustomContentBulk {
  /// Returns a new [CustomContentBulk] instance.
  CustomContentBulk({
    this.id,
    this.type,
    this.status,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CustomContentBulk &&
    other.id == id &&
    other.type == type &&
    other.status == status &&
    other.title == title &&
  ...
  @override
  String toString() => 'CustomContentBulk[id=$id, type=$type, status=$status, title=$title, spaceId=$spaceId, pageId=$pageId, blogPostId=$blogPostId, customContentId=$customContentId, authorId=$authorId, createdAt=$createdAt, version=$version, body=$body, links=$links]';
  ...
  /// Returns a new [CustomContentBulk] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CustomContentBulk? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CustomContentBulk(
        ...
        body: CustomContentBodyBulk.fromJson(json[r'body']),
  ...
  static List<CustomContentBulk> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomContentBulk>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomContentBulk.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CustomContentBulk> mapFromJson(dynamic json) {
    final map = <String, CustomContentBulk>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CustomContentBulk.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CustomContentBulk-objects as value to a dart map
  static Map<String, List<CustomContentBulk>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CustomContentBulk>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CustomContentBulk.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
