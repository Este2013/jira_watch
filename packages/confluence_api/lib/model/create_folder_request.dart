...
class CreateFolderRequest {
  ...
  @override
  String toString() => 'CreateFolderRequest[spaceId=$spaceId, title=$title, parentId=$parentId]';
  ...
  static CreateFolderRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'spaceId'), 'Required key "CreateFolderRequest[spaceId]" is missing from JSON.');
        assert(json[r'spaceId'] != null, 'Required key "CreateFolderRequest[spaceId]" has a null value in JSON.');
        return true;
      }());
